...
class Lexer implements Runnable {
    ...
    private final String name;            /* the name of the input; used only for error reports */
    private final String input;           /* the string being scanned */
    private final String leftDelim;
    private final String rightDelim;
    private final LinkedBlockingQueue<Token> tokens;
